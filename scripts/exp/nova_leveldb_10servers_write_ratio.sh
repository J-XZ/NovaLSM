...
for persist_log_record in "none"; do #"disk" "mem"
	for nranges_per_server in "64"; do  #"4" "16" "1"
		...
		for dist in "zipfian"; do                        #""
			for workload in "workloada80" "workloada90"; do #"workloada60" "workloada70"   #"workloadw"
				run_bench
			done
		done
	done
